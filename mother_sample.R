...
# a <- ggplot(data = r2csv,aes(sam_size ,  r2))
# a + geom_point(aes(var_num))
#  
# 
#  geom_point(color = "red",size=1,shape=0)
# a+ geom_line(color = "red",size=1)
# a + labs( title = "Outsample R2 and Sample Size Change as Variable Number Increase")


plot(r2csv[,2],r2csv[,4],  lwd = 2, cex = .2, ann = F)
